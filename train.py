...
def main():
  ...
  parser.add_argument("--gamma", default=0.995, type=float, dest='gamma', help="Multiplicative factor applied to the learning rate after every epoch.")
  parser.add_argument("--lr", default=4.375e-4, type=float, dest='lr', help="Initial learning rate.")
